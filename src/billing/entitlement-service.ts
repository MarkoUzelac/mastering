...
class EntitlementService {
  ...
  public canExport() { return { allowed: true, reason: undefined as string | undefined }; }
  ...
  public setEntitlementFromServer(entitlement: UserEntitlement, usage?: UserUsage) {
    this.entitlement = { ...entitlement, plan: 'free', status: 'FREE', features: Array.from(new Set([...(entitlement.features || []), ...FREE_FEATURES])), lastVerifiedAt: Date.now() };
