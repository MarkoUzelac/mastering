  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 md:px-8 text-left space-y-8 animate-fade-in">
      <div className="border-b border-[#242830] pb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-[#F2F2EE]">Data Subject Access & Privacy Request</h1>
      ...
      <div className="p-4 rounded-sm bg-[#121418] border border-[#2A2E35] flex items-start gap-3">
        ...
        <div className="text-xs text-[#8E95A2] space-y-1">
          ...
          <p>
            Because your audio files are processed 100% locally in your browser, our servers <strong className="text-[#F2F2EE]">do not store or possess your audio files</strong>. Data held by us is strictly limited to your email, subscription plan state, and invoice ledger.
          </p>
        </div>
      </div>
      ...
      {!statusMessage ? (
        <form onSubmit={handleSubmit} className="p-6 rounded-sm bg-[#121418] border border-[#242830] space-y-4 text-xs">
          ...
          <div className="space-y-1">
            <label className="text-[#A0A6B2]">Your Registered Account Email <span className="text-[#B7F000]">*</span></label>
            <input
              type="email"
              required
              value={email}
