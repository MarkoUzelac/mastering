  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4 md:px-8 text-left space-y-8 animate-fade-in">
      <div className="border-b border-[#242830] pb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-[#F4F3EF]">Data Subject Access & Privacy Request</h1>
      ...
      <div className="p-4 rounded-xl bg-[#121418] border border-[#2A2E35] flex items-start gap-3">
        <Shield className="w-4 h-4 text-[#D6AF62] shrink-0 mt-0.5" />
        <div className="text-xs text-[#8E95A2] space-y-1">
          <span className="font-semibold text-[#F4F3EF]">Audio Privacy Reminder:</span>
          <p>
            Because your audio files are processed 100% locally in your browser, our servers <strong className="text-[#F4F3EF]">do not store or possess your audio files</strong>. Data held by us is strictly limited to your email, subscription plan state, and invoice ledger.
          </p>
        </div>
      </div>
      ...
      {!statusMessage ? (
        <form onSubmit={handleSubmit} className="p-6 rounded-xl bg-[#121418] border border-[#242830] space-y-4 text-xs">
          <div className="space-y-1">
            <label className="text-[#A0A6B2]">Request Type <span className="text-[#D6AF62]">*</span></label>
            <select
              value={requestType}
          ...
          <div className="space-y-1">
            <label className="text-[#A0A6B2]">Your Registered Account Email <span className="text-[#D6AF62]">*</span></label>
            <input
              type="email"
              required
              value={email}
          ...
          <div className="space-y-1">
            <label className="text-[#A0A6B2]">Specific Details / Notes (Optional)</label>
            <textarea
              rows={3}
              value={details}
        ...
        <div className="p-6 rounded-xl bg-[#121418] border border-[#2E3540] text-center space-y-3">
          ...
          <div className="text-base font-semibold text-[#F4F3EF]">Request Logged Successfully</div>
