  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 md:px-8 text-left space-y-8 animate-fade-in">
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">1. Overview & Service Description</h2>
        <p>
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">2. Subscriptions, Pricing & Automatic Renewal</h2>
        <div className="p-4 rounded-sm bg-[#121418] border border-[#2A2E35] space-y-2 text-xs">
          <div className="flex items-center gap-2 font-semibold text-[var(--text-primary)]">
            <DollarSign className="w-4 h-4 text-[var(--accent-lime)]" />
            <span>Subscription Plans & Pricing Structure</span>
          </div>
          <ul className="list-disc list-inside space-y-1 text-[var(--text-tertiary)] pl-2">
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">3. User Content & 100% Commercial Release Rights</h2>
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">4. Acceptable Use Policy</h2>
        <p>You agree not to use the service to:</p>
        <ul className="list-disc list-inside space-y-1 text-xs text-[var(--text-tertiary)] pl-2">
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">5. Limitation of Liability & Disclaimers</h2>
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">6. Governing Law & Jurisdiction</h2>
        <p className="text-xs text-[var(--text-tertiary)]">
      ...
      <section className="p-4 rounded-sm bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-xs text-[var(--text-tertiary)] space-y-1">
        <div className="font-semibold text-[var(--text-primary)]">Legal Notice & Inquiries</div>
        <div>Entity: {LEGAL_CONFIG.businessName}</div>
        <div>Support: <a href={`mailto:${LEGAL_CONFIG.supportEmail}`} className="text-[var(--accent-lime)] underline">{LEGAL_CONFIG.supportEmail}</a></div>
      </section>
    </div>
  );
};
