    ...
    <div className="max-w-4xl mx-auto py-10 px-4 md:px-8 text-left space-y-8 animate-fade-in">
      ...
      <div className="p-5 rounded-sm bg-[#121418] border border-[#2A2E35] space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-[var(--text-secondary)]">
          <div className="p-3 bg-[var(--bg-secondary)] rounded-sm border border-[var(--border-subtle)]">
            <strong className="text-[var(--text-primary)]">Subscription Cancellation:</strong> Stop future automatic renewals at any time with one click. Access continues until the prepaid period ends.
          </div>
          <div className="p-3 bg-[var(--bg-secondary)] rounded-sm border border-[var(--border-subtle)]">
            <strong className="text-[var(--text-primary)]">Refund Requests:</strong> Return of funds charged for a specific billing cycle under statutory rights or verified billing errors.
          </div>
        </div>
      </div>
      ...
      <section className="space-y-3 text-sm text-[var(--text-secondary)] leading-relaxed">
        ...
        <div className="p-4 rounded-sm bg-[var(--bg-elevated)] border border-[#2E3540] text-xs text-[var(--text-tertiary)] space-y-2">
          <div className="font-semibold text-[var(--accent-lime)]">Digital Content Performance Exception (Directive 2011/83/EU Art. 16(m))</div>
          <p>
