  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 md:px-8 text-left space-y-8 animate-fade-in">
      <div className="border-b border-[#242830] pb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-[#F4F3EF]">Refund & Cancellation Policy</h1>
      ...
      <div className="p-5 rounded-xl bg-[#121418] border border-[#2A2E35] space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-[#A0A6B2]">
          <div className="p-3 bg-[#0E1013] rounded-lg border border-[#242830]">
            <strong className="text-[#F4F3EF]">Subscription Cancellation:</strong> Stop future automatic renewals at any time with one click. Access continues until the prepaid period ends.
          </div>
          <div className="p-3 bg-[#0E1013] rounded-lg border border-[#242830]">
            <strong className="text-[#F4F3EF]">Refund Requests:</strong> Return of funds charged for a specific billing cycle under statutory rights or verified billing errors.
          </div>
        </div>
      </div>
      ...
      <section className="space-y-3 text-sm text-[#A0A6B2] leading-relaxed">
        <h2 className="text-lg font-semibold text-[#F4F3EF]">1. Statutory EU Right of Withdrawal (14 Days)</h2>
        <p>
        ...
        <div className="p-4 rounded-lg bg-[#14171D] border border-[#2E3540] text-xs text-[#8E95A2] space-y-2">
          <div className="font-semibold text-[#D6AF62]">Digital Content Performance Exception (Directive 2011/83/EU Art. 16(m))</div>
          <p>
      ...
      <section className="space-y-3 text-sm text-[#A0A6B2] leading-relaxed">
        <h2 className="text-lg font-semibold text-[#F4F3EF]">2. Circumstances Eligible for Refunds</h2>
      ...
      <section className="space-y-3 text-sm text-[#A0A6B2] leading-relaxed">
        <h2 className="text-lg font-semibold text-[#F4F3EF]">3. How to Submit a Refund Request</h2>
        <p className="text-xs text-[#8E95A2]">
          To request a refund, please contact our support team at <a href={`mailto:${LEGAL_CONFIG.supportEmail}`} className="text-[#D6AF62] underline">{LEGAL_CONFIG.supportEmail}</a> with your registered account email and Stripe receipt / invoice number. We process verified requests within 3–5 business days directly back to your original payment method.
        </p>
      </section>
    </div>
  );
