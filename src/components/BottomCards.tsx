    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
      ...
      <div className="bg-[#0D0E0C] border border-[#222420] rounded-xl p-4 flex flex-col justify-between shadow-sm">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[10px] font-mono text-[#686A63]">DSP ENGINE</span>
        </div>
      ...
      <div className="bg-[#0D0E0C] border border-[#222420] rounded-xl p-4 flex flex-col justify-between shadow-sm">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1 rounded bg-[#151714] hover:bg-[#1E232B] text-[#A5A69F] hover:text-[#F2F2EE] border border-[#222420] transition cursor-pointer"
        ...
        <div className="bg-[#08090C] border border-[#1E232B] rounded-lg p-2.5 my-auto">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-mono text-[#B7F000] uppercase px-1.5 py-0.5 bg-[#B7F000]/10 rounded border border-[#B7F000]/20">
              {currentPreset?.category || 'Mastering'}
            </span>
          </div>
          <p className="text-[11px] text-[#686A63] mt-1 line-clamp-2 leading-relaxed">
      ...
      <div className="bg-[#0D0E0C] border border-[#222420] rounded-xl p-4 flex flex-col justify-between shadow-sm">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-[10px] font-mono text-[#686A63]">SNAPSHOTS</span>
        </div>
        ...
        <div className="space-y-1.5 my-auto">
          {snapshots.slice(0, 3).map((item, idx) => (
            <div
              ...
              className="flex items-center justify-between px-2.5 py-1 rounded bg-[#08090C] hover:bg-[#151714] border border-[#1E232B] text-xs cursor-pointer transition group"
            >
              <div className="flex items-center gap-2">
                <span className="text-[10px] font-mono text-[#686A63]">{item.time}</span>
                <span className="text-[11px] text-[#A5A69F] group-hover:text-[#F2F2EE] font-medium truncate max-w-[130px]">
                  {item.name}
                </span>
              </div>
              <span className="text-[10px] font-mono text-[#B7F000] group-hover:underline">
                Restore
              </span>
            </div>
          ))}
