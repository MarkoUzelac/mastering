      ...
      <div className="max-w-[1920px] mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          >
            ...
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-[#B7F000] to-[#8CA800] flex items-center justify-center text-\[#F2F2EE\] shadow-[0_0_12px_rgba(139,92,246,0.35)]">
          ...
          <div className="relative hidden md:block">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[#F2F2EE] bg-[#151714] hover:bg-[#1E232B] border border-[#222420] rounded-lg transition cursor-pointer"
            >
            ...
            {sessionDropdownOpen && (
              <div className="absolute left-0 mt-1.5 w-56 bg-[#0D0E0C] border border-[#222420] rounded-xl shadow-2xl p-1.5 z-50 space-y-1">
                <div className="px-2.5 py-1 text-[10px] font-mono text-[#686A63] uppercase tracking-wider">
                  Active Sessions
                </div>
                <button
                  onClick={() => setSessionDropdownOpen(false)}
                  className="w-full text-left p-2 rounded-lg bg-[#1C162E] text-[#F2F2EE] text-xs flex items-center justify-between font-medium"
                >
                ...
                <button
                  onClick={() => setSessionDropdownOpen(false)}
                  className="w-full text-left p-2 rounded-lg hover:bg-[#151714] text-[#A5A69F] text-xs"
                >
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-[#A5A69F] hover:text-[#F2F2EE] bg-[#151714] hover:bg-[#1E232B] border border-[#222420] rounded-lg transition cursor-pointer"
          >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Undo / Redo Buttons */}
          <div className="flex items-center gap-0.5 bg-[#151714] border border-[#222420] rounded-lg p-0.5">
            <button
              onClick={() => {
          ...
          <button
            ...
            className="flex items-center gap-1.5 p-1.5 sm:px-2.5 sm:py-1.5 min-w-[32px] min-h-[32px] sm:min-w-[36px] sm:min-h-[36px] justify-center text-xs text-[#A5A69F] hover:text-[#F2F2EE] bg-[#151714] hover:bg-[#1E232B] border border-[#222420] rounded-lg transition cursor-pointer active:scale-95"
          ...
          <button
            ...
            className="p-1.5 min-w-[32px] min-h-[32px] sm:min-w-[36px] sm:min-h-[36px] flex items-center justify-center text-[#A5A69F] hover:text-[#F2F2EE] bg-[#151714] hover:bg-[#1E232B] border border-[#222420] rounded-lg transition cursor-pointer active:scale-95"
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-1.5 text-xs font-semibold rounded-lg text-\[#F2F2EE\] bg-gradient-to-r from-[#B7F000] to-[#7C3AED] hover:from-[#9333EA] hover:to-[#B7F000] transition shadow-[0_0_12px_rgba(139,92,246,0.35)] cursor-pointer active:scale-95 shrink-0"
          >
