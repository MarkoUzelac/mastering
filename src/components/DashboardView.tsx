    ...
    <div className="max-w-[1400px] mx-auto space-y-8 py-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0E1013] border border-[#222420] rounded-sm p-6">
        <div>
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-[#F2F2EE] mt-1">
            Mastering Projects &amp; Library
          </h1>
          <p className="text-xs sm:text-sm text-[#A5A69F] mt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#0E1013] border border-[#222420] rounded-sm p-5 space-y-2">
          ...
          <div className="text-3xl font-bold font-mono text-[#F2F2EE] num-tabular">
            14
          </div>
          <div className="text-xs text-[#686A63]">
        ...
        <div className="bg-[#0E1013] border border-[#222420] rounded-sm p-5 space-y-2">
          ...
          <div className="text-3xl font-bold font-mono text-[#F2F2EE] num-tabular">
            {usage.exportsUsed} <span className="text-sm font-normal text-[#A5A69F]">/ {isPro ? '∞' : usage.exportsLimit}</span>
          </div>
          <div className="text-xs text-[#686A63]">
        ...
        <div className="bg-[#0E1013] border border-[#222420] rounded-sm p-5 space-y-2">
          ...
          <div className="text-3xl font-bold font-mono text-[#F2F2EE] num-tabular">
            1.2 <span className="text-sm font-normal text-[#A5A69F]">of 10 GB</span>
          </div>
          {/* Progress bar */}
          <div className="w-full h-1.5 bg-[#151714] rounded-full overflow-hidden">
            <div className="w-[12%] h-full bg-[#B7F000] rounded-full" />
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#0E1013] border border-[#222420] rounded-sm overflow-hidden">
        <div className="p-4 border-b border-[#222420] flex items-center justify-between">
          ...
          <span className="text-xs text-[#A5A69F] font-mono">3 Tracks</span>
        </div>

        <div className="divide-y divide-[#222420] text-xs">
          {recentMasters.map((track) => (
            <div
              key={track.id}
              className="p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-[#151714]/50 transition"
            >
              <div className="flex items-center gap-3 min-w-0">
                <div className="w-9 h-9 rounded bg-[#151714] border border-[#222420] flex items-center justify-center text-[#B7F000] shrink-0">
                  <Music className="w-4 h-4" />
                </div>
                <div className="min-w-0">
                  <div className="font-semibold text-[#F2F2EE] truncate">{track.title}</div>
                  <div className="text-[11px] text-[#A5A69F] flex items-center gap-2 mt-0.5">
              ...
              <div className="flex items-center gap-6 font-mono text-[11px]">
                <div>
                  <span className="text-[#686A63] block text-[9px] uppercase">LOUDNESS</span>
                  <span className="text-[#F2F2EE]">{track.lufs}</span>
                </div>
                <div>
                  <span className="text-[#686A63] block text-[9px] uppercase">TRUE PEAK</span>
                  <span className="text-[#B7F000]">{track.truePeak}</span>
                </div>
                <div className="hidden sm:block">
                  <span className="text-[#686A63] block text-[9px] uppercase">MODIFIED</span>
                  <span className="text-[#A5A69F]">{track.date}</span>
                </div>
              </div>
